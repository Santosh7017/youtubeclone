    ...
    <div className="flex items-center justify-center gap-5">
        ...
        <div  className='flex gap-5 items-center text-xl'>
            ...
            <div className="relative">
                <BsBell />
                <span  className='absolute vottom-2 left-2 text-xs bg-red-600 rounded-full px-1'>
                    9+
                </span>
            </div>
        </div>
        <img
          src="	https://yt3.ggpht.com/yti/ADpuP3OjK4iYxlgyPKj6-YTNXmD6gJadhV4ad4FNaYRVWA=s88-c-k-c0x00ffffff-no-rj"
